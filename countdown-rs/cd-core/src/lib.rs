...
pub const W_DIVISOR: i64 = 1000 * 60 * 60 * 24 * 7;
pub const D_DIVISOR: i64 = 1000 * 60 * 60 * 24;
pub const H_DIVISOR: i64 = 1000 * 60 * 60;
pub const M_DIVISOR: i64 = 1000 * 60;
pub const S_DIVISOR: i64 = 1000;
pub const MS_DIVISOR: i64 = 1;
...
#[must_use]
pub fn calculate_interval(interval: i64, divisor: i64) -> (i64, String) {
...
impl Accumulate<&str> for MyStr {
    ...
    fn accumulate(self, interval: i64, format_option: &FormatOption) -> (i64, Self) {
        ...
        let new_accumulator: Self = Self {
            inner: self.inner + &unit_count + time_unit.suffix + " ",
        };
